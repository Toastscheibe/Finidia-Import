...
var fensterHoehe = 0,
	seitenHoehe = 0,
	bewegungsTeiler = 1.1;	// Die Verschiebung der Hintergrundebene entspricht der gescrollten Hoehe geteilt durch diesen Wert.
...
function parallaxeVerschiebung() {
	...
	if ( gegenwaertigeSektion == 1 ) {
		$( '#stage .hintergrundbild' ).css( 'top', bewegungAktiv );
	} else {
		$( '#stage .hintergrundbild' ).css( 'top', bewegungProaktiv );
	};
	if ( gegenwaertigeSektion == 2 ) {
		$( '#products .hintergrundbild' ).css( 'top', bewegungAktiv );
	} else {
		$( '#products .hintergrundbild' ).css( 'top', bewegungProaktiv );
	};
	if ( gegenwaertigeSektion == 3 ) {
		$( '#company .hintergrundbild' ).css( 'top', bewegungAktiv );
    } else {
		$( '#company .hintergrundbild' ).css( 'top', bewegungProaktiv );
	};
}
